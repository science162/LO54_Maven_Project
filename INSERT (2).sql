...
INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2018-12-22','2018-12-30',20,1,1);

INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2019-01-12','2019-02-17',20,1,2);
	
INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2019-03-22','2019-04-17',20,1,3);


INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2019-01-12','2018-02-17',20,2,4);

INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ( '2019-02-26','2019-03-30',20,2,1);
INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2019-04-10','2019-05-27',20,2,2);
	

INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2018-12-22','2018-12-30',20,2,3);
INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2019-01-20','2019-02-20',20,2,4);
INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2019-03-20','2019-04-20',20,3,1);
	
INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2019-01-12','2018-02-17',20,3,2);
INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2019-02-26','2019-03-30',20,3,3);
	
INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2019-01-20','2019-02-20',20,3,4);
INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2019-04-10','2019-06-27',20,4,1);	
INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2019-01-12','2019-02-17',20,4,2);
INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2019-03-22','2019-06-17',20,4,3);	
INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2018-11-22','2018-12-30',20,4,3);
INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2019-01-20','2019-02-20',20,4,4);
INSERT INTO session (START_DATE,END_DATE,NBRE_PLACE,ID_COURSE,ID_LOCATION) 
	Values ('2019-02-25','2019-04-20',20,5,1);
